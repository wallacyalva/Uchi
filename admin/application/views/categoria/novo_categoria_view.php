        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="<?=base_url("categoria/new");?>">Categoria</a></li>                    
                    ...
                    <div class="row">      
                        <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <form class="form-horizontal" id="cadFormCategoria" method="post" action="<?=base_url("categoria/new")?>">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">É uma Categora Principal? <span class="required">*</span></label>
                                                ...
                                                <label class="col-md-3 control-label">É uma Categora de? <span class="required">*</span></label>
                                                    ...
                                                    <label class="radio-material">
                                                        <input id="radio1" type="radio" name="tipo" value="0">
                                                        <span class="outer"><span class="inner"></span></span> Anuncios
                                                    </label>                                            
                                                    <label class="radio-material">
                                                        <input id="radio2" type="radio" name="tipo" value="1">
                                                        <span class="outer"><span class="inner"></span></span> Classificados
                                                    </label>
                                                    <label class="radio-material">
                                                        <input id="radio3" type="radio" name="tipo" value="2">
