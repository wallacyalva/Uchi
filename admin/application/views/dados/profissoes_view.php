<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">                    
            <h2><span class="fa fa-users"></span> Profissões</h2>
        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form action="<?=base_url()?>dados/inserirProfissao" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-3 form-group"><label for="nome"><h3>Adicionar Profissão:</h3></label></div>
                                ...
                                <table class="table datatable table-striped table-condensed table-actions">
                                    ...
                                    <tbody>
                                        <?php foreach($profissoes as $profissao) { ?>
                                            <tr id="area_<?=$profissao->id?>">
                                                <td><?=$profissao->nome?></td>
                                                <td><?=$profissao->pai == 0 ? "<p class='text-warning'>Categoria</p>" : "<p class='text-info'>Profissão</p>" ?></td>                                               
                                                <td>
                                                    <button class="btn btn-warning btn-condensed" onclick="alterarModal(<?=$profissao->id?>)"><i class="fa fa-pencil"></i></button>
                                                    <button class="btn btn-danger btn-condensed" onclick="deleteConfirm(<?=$profissao->id?>,'<?=$profissao->pai == 0 ? "Categoria" : "Profissão" ?>')"><i class="fa fa-times"></i></button>
                                                </td>                                                    
                                            </tr>
                                        <?php } ?>
                                    </tbody>
...
<div id="alterarModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?=base_url()?>dados/alterarProfissao" method="post">
    ...
    function deleteConfirm(id, text) {
        noty({
            ...
            buttons: [{addClass: 'btn btn-success btn-clean', text: 'Sim', onClick: function($noty) {
                $.ajax({
                    url: '<?=base_url()?>dados/deletarProfissao',
                    type: 'post',
                    data: {id: id},
                    success: function() {
