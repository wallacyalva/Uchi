<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">                    
            <h2><span class="fa fa-users"></span> Areas</h2>
        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form action="<?=base_url()?>dados/inserirArea" method="post">
                                    <div class="row" style="margin-bottom: 10px">
                                        <div class="col-md-12">
                                            <div class="col-md-3 form-group"><label for="nome"><h3>Adicionar Area:</h3></label></div>
                                    ...
                                    <tbody>
                                        <?php foreach($areas as $area) { ?>
                                            <tr id="area_<?=$area->id?>">
                                                <td><?=$area->nome?></td>                                                 
                                                <td>
                                                    <button class="btn btn-warning btn-condensed" onclick="alterarModal(<?=$area->id?>)"><i class="fa fa-pencil"></i></button>
                                                    <button class="btn btn-danger btn-condensed" onclick="deleteConfirm(<?=$area->id?>)"><i class="fa fa-times"></i></button>
                                                </td>                                                    
                                            </tr>
                                        <?php } ?>
                                    </tbody>
...
<div id="alterarModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?=base_url()?>dados/alterarArea" method="post">
    ...
    function deleteConfirm(id) {
        noty({
            ...
            buttons: [{addClass: 'btn btn-success btn-clean', text: 'Sim', onClick: function($noty) {
                ...
                $noty.close();
                noty({text: 'Area Apagada!', layout: 'topRight', type: 'success'});
                }},
