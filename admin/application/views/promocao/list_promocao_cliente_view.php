        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="<?=base_url("promocao");?>">Promoção</a></li>                    
                    <li class="active"><a href="<?=base_url("promocao/new");?>/<?=$this->uri->segment(3)?>">Nova Promoção</a></li>
                    <li class="active">Promoções do Cliente (<?=$cliente->name_company?>)</li>                    
                </ul>
                <!-- END BREADCRUMB -->  
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-12">
                                            <a href="<?=base_url("promocao/editarpromocaocliente/".$this->uri->segment(3)."/".$promocao->id);?>"><button class="btn btn-primary btn-condensed"><i class="fa fa-edit"></i></button>
