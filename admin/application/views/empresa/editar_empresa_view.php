<div class="page-container">
    ...
    <div class="page-content">    
        ...
        <div class="page-content-wrap">
            <div class="row">      
                <div class="col-md-12">
                    <form id="editarUsuário" action="<?=base_url()?>empresa/editar/<?=$usuario->id?>?>" method="post" class="form-horizontal" role="form">       
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="cnpj" id="cnpj" class="form-control" value="<?=$usuario->cnpj?>">
                                    </div>
                                </div>
                                <div class="form-group">
