                                    ...
                                    <tbody>
                                        <?php foreach($usuarios as $usuario) { ?>
                                            <tr id="user_<?=$usuario->id?>">
                                                ...
                                                <td>
                                                    <a href="<?=base_url()?>administrador/editar/<?=$usuario->id?>"><button class="btn btn-success btn-condensed"><i class="fa fa-pencil"></i></button></a>
    ...
    function deleteConfirm(id_usuario) {
        noty({
            ...
            buttons: [{addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                $.ajax({
                    url: '<?=base_url()?>administrador/deletar',
                    type: 'post',
