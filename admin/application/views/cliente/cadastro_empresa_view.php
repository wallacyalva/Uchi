        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <div class="page-content-wrap">
                    <div class="row">      
                        <div class="col-md-12">
                            <form id="addFormCliente" action="<?=base_url();?>negocio/cliente/new_cliente" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">       
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                                ...
                                                <div class="form-check text-center">
                                                    ...
                                                    <label class="form-check-label" for="aceitarTermos">Li e concordos com os <a target="_blank" href="<?=base_url('negocio/documents') . "/contratoAcheiDeTudo.pdf"?>">Termos de Uso</a><span class="required">*</span></label>
                                                </div>
