        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="<?=base_url("banner/new");?>">Banner</a></li>                    
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-user"></span> Editar Banner</h2>
                </div>
                <!-- END PAGE TITLE -->
                <?php 
                    ...
                    <div class="row">      
                        <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <form class="form-horizontal" id="cp_crop_banner" method="post" action="<?=base_url("banner/cropBannerPhotoEditar")?>">
                                                    ...
                                                    <div class="col-md-7">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="text-center" id="cp_target_banner">
                                                                        Use o formulario a baixo para editar o banner. Apenas Arquivos .jpg!
                                                                    </div>
                                                            ...
                                                            <form id="cp_upload_banner" method="post" enctype="multipart/form-data" action="<?=base_url("banner/uploadPhotoEditar")?>">
